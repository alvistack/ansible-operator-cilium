...
# alvistack/ansible-operator-cilium-bundle:$VERSION and alvistack/ansible-operator-cilium-catalog:$VERSION.
IMAGE_TAG_BASE ?= alvistack/ansible-operator-cilium
